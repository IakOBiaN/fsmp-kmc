...
double interpolation(double dist_n, double ang1, double ang2, double beta) {
                ...
                v_find.y = ang1 / da;
                v_find.z = ang2 / da;
                v_000.value = FF(v_000.place.x, v_000.place.y, v_000.place.z);
                v_010.value = FF(v_010.place.x, v_010.place.y, v_010.place.z);
                v_100.value = FF(v_100.place.x, v_100.place.y, v_100.place.z);
                v_110.value = FF(v_110.place.x, v_110.place.y, v_110.place.z);
                v_001.value = FF(v_001.place.x, v_001.place.y, v_001.place.z);
                v_011.value = FF(v_011.place.x, v_011.place.y, v_011.place.z);
                v_101.value = FF(v_101.place.x, v_101.place.y, v_101.place.z);
                v_111.value = FF(v_111.place.x, v_111.place.y, v_111.place.z);
