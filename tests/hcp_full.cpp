// Regression test: the full engine on the real TMA simple potential.
// Runs only when forcefields/TMA_simple_2020.v2.bin is present (the runner
// skips it otherwise). Pin: initial HCP energy -62.8605 kJ/mol, the value
// validated against the published simplified-TMA model.
#include "../includes.h"
...
string unit_cell_name = "0_hcp_full.xyz";
string xyz_name = "1_hcp_full.xyz";
stringstream name_of_file_for_statistics;
void complex_names()
{
  name_of_file_for_statistics << "2_hcp_full.dat";
}
