...
void PotentialEnergy_SEP(int &nPart, double &Lx, double &Ly,
                     double &Rc, double &Rc2, vector <state> &coordinates, const double &A, double &C_q, double &beta, double &Energy_LJ, double &Energy_QQ)
{
     ...
     for(int molB = (molA + 1); molB < nPart; molB++)
      {
            ...
            valarray<double> l_i={cos(coordinates[molA].phi), sin(coordinates[molA].phi)};
            valarray<double> l_j={cos(coordinates[molB].phi), sin(coordinates[molB].phi)};
            ...
            double xxx  = coordinates[molA].x;
            double yyy  = coordinates[molA].y;
            double x1, y1, r2;
            double x2 = coordinates[molB].x;
            double y2 = coordinates[molB].y;
            ...
            Energy_LJ += 2.0*(4.0*beta*U_LJ); //for two molecules
            Energy_QQ += 2.0*(beta*331.8e-12*U_QQ/eps);
