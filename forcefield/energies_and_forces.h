results energies_and_forces(state molA, state molB, double Lx, double Ly)
{
  ...
  U_LJ *= 4.0*eps*beta_onlykb;
  U_QQ *= 1.0*beta_onlykb; //sigma;
  en_and_press.p_X_LJ *= 24.0*eps*beta_onlykb;
  en_and_press.p_Y_LJ *= 24.0*eps*beta_onlykb;
  en_and_press.p_X_QQ *= 1.0*beta_onlykb;//sigma;
  en_and_press.p_Y_QQ *= 1.0*beta_onlykb;//sigma;
