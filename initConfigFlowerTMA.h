...
void initConfigFlowerTMA (int &nPart, double &density, vector <state> &coordinates, double &Lx, double &Ly, double &state_dens)
{
...
double L_cell = h3_bond_dist + 2*h_bond_dist*cos(30.0/180.0*PI); //size of the simple unit cell
